...
do
	...
	$CPPC -g -shared -o $OUT_DIR/tdu2_no_debugger_detection_${arch}.asi $OUT_DIR/tdu2_no_debugger_detection.o -Lminhook_1.3.3/bin -lntdll -Wl,-Bstatic -lpthread -l${min_hook_lib} -static-libgcc -static-libstdc++
